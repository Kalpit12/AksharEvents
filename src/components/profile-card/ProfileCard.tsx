...
import React, { useEffect, useRef, useCallback, useMemo, type CSSProperties, type ReactNode } from "react";
...
const ProfileCardComponent = ({
  ...
  const cardClasses = ["pc-card", cardClassName].filter(Boolean).join(" ");
      ...
      <div ref={shellRef} className="pc-card-shell">
        <section className={cardClasses}>
          <div className="pc-inside">
            ...
            {children ? (
              <div className="pc-custom-slot">{children}</div>
            ) : (
              <>
