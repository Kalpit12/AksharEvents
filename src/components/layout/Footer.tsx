...
const socialLinks = [
  {
    label: "Facebook",
    href: "https://facebook.com/axarevents",
    icon: (
  ...
  {
    label: "Instagram",
    href: "https://instagram.com/axarevents",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5" aria-hidden="true">
  ...
  {
    label: "LinkedIn",
    href: "https://linkedin.com/company/axarevents",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" className="h-5 w-5" aria-hidden="true">
    ...
    return (
      <div className="space-y-2 pb-2">
        ...
        >
          ...
          <span className={nowrapText}>info@axarevents.com</span>
        </a>
        <a
