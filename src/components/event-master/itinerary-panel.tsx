    ...
    <div className="space-y-6">
      <section className="rounded-2xl border border-border bg-card p-5">
        ...
        <p className="mb-4 text-xs text-muted-foreground">
          Based on registration step &quot;Tours &amp; travel arrangements&quot;. Tour &amp; travel
          itinerary notifications are sent only to these exhibitors and their team members.
        </p>
        ...
        <div className="mb-4 flex flex-wrap items-start justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Manually add sessions and timings for the expo. Exhibitors see these under Schedules.
            </p>
          </div>
          <Button
            type="button"
