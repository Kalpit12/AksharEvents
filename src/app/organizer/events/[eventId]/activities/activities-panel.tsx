        ...
        <CardContent>
          <form onSubmit={handleCreate} className="grid gap-4 sm:grid-cols-2">
            <div className="sm:col-span-2 flex gap-2">
              <Button
                type="button"
                variant={kind === "TOUR" ? "default" : "outline"}
                size="sm"
              ...
              <Button
                type="button"
                variant={kind === "TRAVEL" ? "default" : "outline"}
                size="sm"
            ...
            <div className="sm:col-span-2">
              <Button type="submit" disabled={loading}>
                {loading ? "Publishing…" : "Publish option"}
              </Button>
            </div>
          </form>
        </CardContent>
              ...
              <li key={activity.id} className="flex flex-col gap-3 rounded-xl border border-border p-4 sm:flex-row sm:items-center sm:justify-between">
                <div>
                  ...
                  {Number(activity.price) > 0 && (
                    <p className="text-sm">{formatCurrency(activity.price, activity.currency)}</p>
                  )}
                </div>
